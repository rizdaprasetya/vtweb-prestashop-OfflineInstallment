 $(function() {  
  ...
  function setUpVisibility(){    
    var a = $("#VI_ENABLE_INSTALLMENT").val();      
    switch(a){
      case "off":            
            ...
            hideOptions('VI_INSTALLMENTS_MANDIRI', "class");
            hideOptions('ENABLED_MANDIRI_INSTALLMENT_off', "div");                                    
            hideOptions('VI_INSTALLMENTS_BNI', "class");
      ...
      case "all_product":                                
            ...
            if (EnableMandiri == 1){              
              showOptions('VI_INSTALLMENTS_MANDIRI', "class");
            } else {
              hideOptions('VI_INSTALLMENTS_MANDIRI', "class");
            }

            if (EnableBni == 1){           
              showOptions('VI_INSTALLMENTS_BNI', "class");
            } else {
              hideOptions('VI_INSTALLMENTS_BNI', "class");
            }
            break;
  ...
  $("#VI_ENABLE_INSTALLMENT").on('change', function(e, data) {       
    setUpVisibility();
  });
